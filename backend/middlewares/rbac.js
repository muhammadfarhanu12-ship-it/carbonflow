...
const ROLE_PERMISSIONS = {
  ...
  data_entry: ["supplier:view", "supplier:create", "supplier:update", "supplier:evidence:view", "report:view", "emission:view", "emission:create", "emission:update", "emission:submit", "records:create", "records:edit", "optimization:view", "marketplace:view", "settings:view", "settings:profile:update", "settings:security:update"],
  viewer: ["supplier:view", "supplier:score:view", "supplier:evidence:view", "report:view", "emission:view", "optimization:view", "marketplace:view", "settings:view"],
  auditor: ["supplier:view", "supplier:score:view", "supplier:evidence:view", "supplier:audit:view", "report:view", "report:download", "emission:view", "audit:view", "audit:export", "optimization:view", "marketplace:view", "marketplace:certificate:view", "settings:view"],
};
