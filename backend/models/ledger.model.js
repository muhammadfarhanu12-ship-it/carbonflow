...
const ledgerSchema = withBaseSchema({
  ...
  emissionRecordId: { type: String, ref: "EmissionRecord", default: null, index: true },
  supplierId: { type: String, ref: "Supplier", default: null, index: true },
  supplierVendor: { type: String, default: null, trim: true, index: true },
  ...
  offsetCostUsd: { type: Number, default: 0 },
  internalCarbonPriceUsd: { type: Number, default: 0 },
